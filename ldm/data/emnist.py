...
class EMNISTBase(datasets.EMNIST):
    def __init__(self, datadir, size=None, split="letters", **kwargs):
        self.size = size
...
class EMNISTTrain(EMNISTBase):
    def __init__(self, **kwargs):
        super().__init__(datadir="EMNIST_Train", train=True, download=True, **kwargs)


class EMNISTVal(EMNISTBase):
    def __init__(self, **kwargs):
        super().__init__(datadir="EMNIST_Val", train=False, download=True, **kwargs)
