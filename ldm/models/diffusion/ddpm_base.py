...
class DDPM(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # what training phase is**
        print("#### Phase {}, Client {} ####".format(self.phase, self.client_id))

        loss, loss_dict = self.shared_step(batch, self.phase)
        if loss is None:
            return None
    ...
    def validation_step(self, batch, batch_idx):
        ...
        with self.ema_scope():
            _, loss_dict_ema = self.shared_step(batch, self.phase)
