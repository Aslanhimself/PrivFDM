...
def main():
    ...
    parser.add_argument("-y", type=str, default=None, help="Path to the config file for the model")
    ...
    parser.add_argument("--num_samples", type=int, default=20000, help="Total number of samples to generate")
    ...
    # grid = torch.stack(samples_list, dim=0)  # [n, b, c, h, w]
